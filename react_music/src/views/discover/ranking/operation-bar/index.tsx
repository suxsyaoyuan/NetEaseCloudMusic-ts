...
interface IProps {
  children?: ReactNode
  favorTitle: string // 定义 favorTitle 属性
  shareTitle: string // 定义 shareTitle 属性
  downloadTitle: string // 定义 downloadTitle 属性
  commentTitle: string
}

const SongOperationBar: React.FC<IProps> = (props) => {
